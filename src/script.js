document.addEventListener('DOMContentLoaded', () =>{
    ...
    function logIn(invalid = false){
        ...
        loginForm.addEventListener('submit', () => {
            ...
            fetch('https://battlebots-game-backend.herokuapp.com/users')
            .then(res => res.json())
            .then(users => {
    ...
    function signUp(){
        ...
        signupForm.addEventListener('submit', () => {
            ...
            fetch('https://battlebots-game-backend.herokuapp.com/users', configObj)
            .then(res => res.json())
            .then(user => {
                currentUser = user
                mainMenu()
    ...
    function editUserName(){
        ...
        editForm.addEventListener('submit', () => {
            ...
            fetch(`https://battlebots-game-backend.herokuapp.com/${currentUser.id}`, configObj)
            .then(res => res.json())
            .then(user => {
                currentUser = user
                mainMenu()
    ...
    function createScreen(mode, bot = null){
        ...
        fetch('https://battlebots-game-backend.herokuapp.com/parts')
        .then(res => res.json())
        .then(parts => {
            partsToSend = parts
        })
        .then(() => {
            fetch('https://battlebots-game-backend.herokuapp.com/moves')
            .then(res => res.json())
    ...
    function createForm(parts, moves, mode, bot){
        ...
        heads.forEach(head => {
            ...
            if(mode == 'edit'){
                let botHead = bot.parts.find(part => part.category == 'head')
                if(botHead.id == head.id){
        ...
        torsos.forEach(torso => {
            ...
            if(mode == 'edit'){
                let botTorso = bot.parts.find(part => part.category == 'torso')
                if(botTorso.id == torso.id){
                    option.selected = "selected"
                }
            }
        ...
        lowerBodies.forEach(lowerBody => {
            ...
            if(mode == 'edit'){
                let botLowerBody = bot.parts.find(part => part.category == 'lower_body')
                if(botLowerBody.id == lowerBody.id){
                    option.selected = "selected"
                }
            }
        ...
        moves.forEach(move => {
            ...
            if(mode=='edit'){
                let botMove1 = bot.moves[0]
                if(botMove1.id == move.id){
                    option.selected = "selected"
                }
            }
        ...
        moves.forEach(move => {
            ...
            if(mode == 'edit'){
                let botMove2 = bot.moves[1]
                if(botMove2.id == move.id){
                    option.selected = "selected"
                }
            }
        ...
        moves.forEach(move => {
            ...
            if(mode == 'edit'){
                let botMove3 = bot.moves[2]
                if(botMove3.id == move.id){
                    option.selected = "selected"
                }
            }
        ...
        robotForm.addEventListener('submit', () => {
            ...
            if(mode == 'create'){
                fetch('https://battlebots-game-backend.herokuapp.com/robots', configObj)
                .then(res => res.json())
                .then(() => fetchMyRobots('display'))
            }
            else if(mode == 'edit'){
                fetch(`https://battlebots-game-backend.herokuapp.com/robots/${bot.id}`, configObj)
                .then(res => res.json())
                .then(() => fetchMyRobots('display'))
            }
    ...
    function fetchAllRobots(mode){
        ...
        fetch('https://battlebots-game-backend.herokuapp.com/robots')
        .then(res => res.json())
    ...
    function deleteRobot(robot){
        ...
        fetch(`https://battlebots-game-backend.herokuapp.com/robots/${robot.id}`, configObj)
        .then(mainMenu())
    }
